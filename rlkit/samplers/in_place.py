...
class InPlacePathSampler(object):
    ...
    def obtain_samples(self, deterministic=False, max_samples=np.inf, max_trajs=np.inf, accum_context=True, resample=1, animated=False, glob=True, resample_in_traj=False):
        """
        ...
        while n_steps_total < max_samples and n_trajs < max_trajs:
            path = rollout(
                ...
                recurrent=policy.recurrent, temp_res=policy.temp_res, rnn_sample=policy.rnn_sample, \
                resample_in_traj=resample_in_traj)
