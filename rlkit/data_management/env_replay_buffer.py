...
class MultiTaskReplayBuffer(object):
    ...
    def random_batch(self, task, batch_size, sequence=False, traj_batch_size=-1):
        batch = self.task_buffers[task].random_batch(batch_size, sequence=sequence, traj_batch_size=traj_batch_size)
        # if sequence:
